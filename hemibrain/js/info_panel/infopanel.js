  ...
  )
{
  ...
  */
  InfoPanel.prototype.update = function(data){
    ...
    if (classOfObj === 'LineAggregation') {
      $("#info-intro").hide();
      this.name = new_name;
      // this.connSVG.update(data['connectivity']);
      // this.connTable.updateLines(data['connectivity']);
      this.connTable.reset();
      this.connTable.show();
      this.connTable.updateLines(window.gene_matches);
      this.show();
      ...
      this.summaryTable.update(data['summary'], this.connTable);
      this.show();
      // this.summaryTable.hide();
      this.connSVG.hide();
      $("#info-panel-table-pre").hide();
